...
main:main.o DLApplication.o DLDownloadWidgetController.o DLDownloadWidget.o
	$(CC) -o bin/$(APPNAME) bin/main.o bin/DLApplication.o bin/DLDownloadWidget.o bin/DLDownloadWidgetController.o $(CCARGS)
	ln -sf bin/$(APPNAME) x
...
DLDownloadWidget.o:
	$(CC) -o bin/DLDownloadWidget.o -c src/widgets/DLDownloadWidget.c $(CCARGS)
